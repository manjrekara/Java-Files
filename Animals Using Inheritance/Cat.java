...
public class Cat implements Animal
{
    ...
    public Cat(String n, Size s, String sound){
        name = n;
        say = sound;
        size = s;
        type = "Cat";
    ...
    public void jump(Animal a)    
    {
        if (this.canJump() == true){
            if (this == a)
                System.out.print(""+name+" the "+type+" does a backflip");
            else 
                System.out.print(""+name+" the "+type+" jumps over "+a.getName()+" the "+a.getType()+" ");
        }
        else 
            System.out.print(""+name+" the "+type+" can't jump");
    }
