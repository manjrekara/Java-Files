...
public class Crow implements Animal
{
    ...
    public Crow(String n, Size s, String sound){
        name = n;
        say = sound;
        size = s;
        type = "Crow";
    ...
    public void jump(Animal a)    {
        if (this.canJump() == true){
            if (this == a)
                System.out.println(""+name+" the "+type+" does a loop");
            else 
                System.out.println(""+name+" the "+type+" flys over "+a.getName()+" the "+a.getType()+" ");
        }
        else 
